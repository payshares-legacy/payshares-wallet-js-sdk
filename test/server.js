...
bartek@payshares.org
------------------
Password: 1234567890
TOTP key: no
mainData: {"username":"bartek","server":{"trusted":true,"websocket_ip":"live.payshares.org","websocket_port":9001,"websocket_ssl":false},"gateways":{}}
...
mainData: {"username":"jared","server":{"trusted":true,"websocket_ip":"live.payshares.org","websocket_port":9001,"websocket_ssl":false},"gateways":{}}
...
app.post('/v2/wallets/show', function(req, res) {
  if (req.body.username === 'bartek@payshares.org' && req.body.walletId === '5wA25amh0hEaIaslzHngz6Ow2WuZmmvSmy66atdT588=') {
    res.status(200).send({
      lockVersion: 0,
  ...
  } else if (req.body.username === 'jared@payshares.org' && req.body.walletId === 'zl0+spNHwMMjXV6BBh6Zj2tTLX5b+FsLvMw6/8YWuZQ=' && req.body.totpCode === '000000') {
    res.status(200).send({
      lockVersion: 1,
...
app.post('/v2/wallets/create', function(req, res) {
  if (req.body.username === 'new_user@payshares.org') {
...
app.post('/v2/wallets/recovery/show', function(req, res) {
  if (req.body.username === 'bartek@payshares.org' && req.body.recoveryId === '59d2b0de2cc2bcd00d3fdea2ad3653db8177c473') {
